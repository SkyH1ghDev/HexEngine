...
ImGuiHeapAllocator::ImGuiHeapAllocator(const HexEngine::Graphics::DirectX12::Device& device, const HexEngine::Graphics::DirectX12::DescriptorHeap& descriptorHeap)
{
