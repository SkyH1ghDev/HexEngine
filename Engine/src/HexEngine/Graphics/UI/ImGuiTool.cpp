...
void ImGuiTool::Initialize(const HexEngine::SDL::SDLWindow& window, const HexEngine::Graphics::DirectX12::Device& device, const HexEngine::Graphics::DirectX12::CommandQueue& commandQueue, const HexEngine::Graphics::DirectX12::DescriptorHeap& srvDescriptorHeap, DXGI_FORMAT backBufferFormat, std::uint64_t maxFrameIndex)
{
    IMGUI_CHECKVERSION();
    ImGui::CreateContext();
    ...
    ImGui_ImplSDL3_InitForD3D(window.GetSDLWindow().lock().get());
...
void ImGuiTool::RenderDrawData(const HexEngine::Graphics::DirectX12::CommandList& commandList)
{
